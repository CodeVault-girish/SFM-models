# sfm_extractor/models/hubert_extractor.py
...
class HubertExtractor:
    def __init__(self, device='cpu'):
        ...
        # Use sampling rate from the feature extractor if available, otherwise default to 16000.
    ...
    def extract_features(self, audio_path):
        ...
        if waveform is None:
            return None
        # Remove extra channel dimensions and add batch dimension
    ...
    def extract_folder(self, folder_path, output_file):
        """
        Process all .wav files in the folder and save the extracted HuBERT features to a CSV file.
        """
        data_records = []
        filenames = []
